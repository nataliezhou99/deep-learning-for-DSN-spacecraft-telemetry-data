"""Data utilities for the MRO transformer prediction model."""
...
class SingleTrackPredictionDataset(Dataset):
    ...
    def __len__(self):
        """Return the number of sliding windows available in the track."""

        return max(0, len(self.input_features) - self.window_size + 1)

    def __getitem__(self, index):
        """Return the windowed tensors along with a binary anomaly label."""
